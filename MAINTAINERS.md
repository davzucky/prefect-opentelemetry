...
https://github.com/organizations/davzucky/repositories/new

Upon creation, push the repository to GitHub:
```bash
git remote add origin https://github.com/davzucky/prefect-opentelemetry.git
git branch -M main
git push -u origin main
```

It's recommended to setup some protection rules for main at:
https://github.com/davzucky/prefect-opentelemetry/settings/branches
...
```markdown
::: prefect_opentelemetry.{module_name}
```
